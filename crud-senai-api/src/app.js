// Na apostila, está localizado no Registrar no app.js, 29.10.4
import usersRoutes from "./routes/users.routes.js";
// Importa o framework Express para criar a aplicação web
import express from "express";
// Importa o Helmet, que adiciona headers de segurança HTTP à aplicação
import helmet from "helmet";
// Importa o CORS (Cross-Origin Resource Sharing) para permitir requisições de
//outros domínios
...
// Limita o tamanho máximo de arquivo enviado a 50KB para evitar requisições
//maliciosas muito grandes
...
app.use(
  cors({
    ...
    origin: true,
    // credentials: false não permite que credenciais (cookies, autenticação) sejam
    //enviadas
    credentials: false,
  }),
);
...
// Na apostila , pede para acrescentar esse codigo abaixo, 29.10.4
...
// Nota: Requer exatamente 4 parâmetros (err, req, res, next) para ser reconhecido
//como middleware de erro
